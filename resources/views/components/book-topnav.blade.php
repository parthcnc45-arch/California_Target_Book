    ...
    <aside class="side-nav">
        ...
        <nav class="navbar" id="book-chapters">
            <ul>
                ...
                <li>
                    <a @click="setNav('recall')" :class="{'active': current === 'recall'}">
                        <div class="icon i-2 i-red">@inline('/img/icons/recall.svg')</div>
                        <span>Recalls</span>
                    </a>
                </li>
        ...
        <div id="section-nav" :class="{ 'verbose-mode': verboseMode }">
            ...
            <section id="recall-nav"
                    :class="{'visible': show('recall')}">
