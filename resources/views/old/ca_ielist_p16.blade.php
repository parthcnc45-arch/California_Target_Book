...
@section('title', 'IE Filings (2016 Primary) | California Target Book')
...
//    Util::set_errors();
    ...
    $sql = "SELECT * FROM calaccess_raw_CVR_CAMPAIGN_DISCLOSURE_CD WHERE FILING_ID > '2000000' && FILING_ID < '2060000' && DIST_NO <> '' && FORM_TYPE = 'F496' ORDER BY FILING_ID DESC, AMEND_ID DESC";
    $result = $conn->query($sql);

    echo("<div class='newseg'>");
    echo("<h1>2016 Primary Independent Expenditure Filings</h1>");
...
//    $iespend = [];
    ...
    function getadate($filing)
    {
        ...
        Debugbar::info($sql);
        Debugbar::info(mysqli_error($conn));
    ...
    function getamount($filing)
    {
        ...
        $sql = "SELECT AMOUNT, FILING_ID, LINE_ITEM, EXPN_DSCR, AMEND_ID FROM calaccess_raw_S496_CD WHERE FILING_ID = '$filing' ORDER BY AMEND_ID DESC";
        $result = $conn->query($sql);
        $thisamend = '';
        $lastamend = '';
        $highestamend = '';
