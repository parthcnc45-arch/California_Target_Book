...
$nov_prop_div = "<div id='nov_prop_div'>
		 <div class='top_block'>";
$nov_prop_div .="<p align='center' class='bigme boldme'><span style='font-size: 2em'>\$" . 
...
$nov_prop_div .= $prop_summary_table;
$nov_prop_div .= "</div>
		</div>";
...
$chart_div  = "<div class='box1200' style='width: 1300px; height: 1800px; text-align: center; margin-left: auto; margin-right: auto;' id='chart_div'>";
$chart_div .= "<div class='newseg' id='stacked_total' style='margin-top: 20px; width: 1300px; height: 1800px; border: 2px solid black;'></div>"; 
$chart_div .= "</div>";

$past_div = "<div class='smaller_table' align='center'>
...
$past_div_chart = "<div class='box1800' style='width: 1024px; height: 1800px; text-align: center; margin-left: auto; margin-right: auto;'>";
$past_div_chart .= "<div class='newseg' id='stacked_hist' style='margin-top: 20px; width: 1024px; height: 1800px; border: 2px solid black;'></div>"; 
$past_div_chart .= "</div>";

$cycle_div = "<div id='cycle_div'>
		<div class='huge_table top_block' align='center'>
...
$logo_div = "<div id='logo_div'><img src='/uploaded/CTB_TextLogo.png'></div>";

$enddraw .= "<div class='full_div' id='full_div'>
