...
@section('title', 'Vizualisations Round Two | California Target Book')
...
switch($type) {
	case "CD":
		switch($geo) {
			case "LA":
				$dists = Array("CD25", "CD27", "CD28", "CD29", "CD30", "CD32", "CD33", "CD34", "CD37", "CD38", "CD40", "CD44", "CD47");
				break;
			case "SOCAL":
				$dists = Array("CD31", "CD35", "CD36", "CD39", "CD41", "CD42", "CD45", "CD46", "CD48", "CD49", "CD50", "CD51", "CD52", "CD53");
				break;
			case "NORCAL":
				$dists = Array("CD01", "CD04", "CD06", "CD07", "CD08", "CD09", "CD10", "CD16", "CD21", "CD22", "CD23");
				break;
			case "COAST":
	...
	case "SD":
		switch($geo) {
			...
			case "SOCAL":
				...
				break;
			case "NORCAL":
				$dists = Array("SD01", "SD04", "SD05", "SD06", "SD08", "SD14", "SD16");
				break;
			case "COAST":
				$dists = Array("SD02", "SD03", "SD07", "SD09", "SD10", "SD11", "SD13", "SD15", "SD17", "SD19", "SD99");
				break;
		}
		break;
	case "AD":
		switch($geo) {
			case "LA":
				$dists = Array("AD36", "AD38", "AD39", "AD41", "AD43", "AD45", "AD46", "AD48", "AD49", "AD50", "AD51", "AD54", "AD57", "AD58", "AD59", "AD63", "AD64", "AD66", "AD70", "AD99");
				break;
			case "SOCAL":
				...
				break;
			case "NORCAL":
				$dists = Array("AD01", "AD03", "AD05", "AD06", "AD07", "AD08", "AD09", "AD12", "AD13", "AD21", "AD23", "AD26", "AD31", "AD32", "AD34", "AD97");
				break;
			case "COAST":
				$dists = Array("AD02", "AD04", "AD10", "AD11", "AD15", "AD16", "AD17", "AD18", "AD19", "AD20", "AD22", "AD24", "AD25", "AD27", "AD28", "AD29", "AD30", "AD35", "AD37", "AD44", "AD96");
				break;
...
foreach($sections as $section => $verbose) {
    ...
    $analysis_key = "VIZ2_" . $type . "_" . $geo . "_" . $distnum;
    $map_url = '/uploaded/viz21b/' . $verbose . '_Map.jpg';
    $res_url = '/uploaded/viz21b/' . $verbose . '_Res.jpg';
