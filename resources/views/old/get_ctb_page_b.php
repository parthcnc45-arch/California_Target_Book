...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="dstyle/normalize.css" />
        <link rel="stylesheet" type="text/css" href="dstyle/demo.css" />
        <link rel="stylesheet" type="text/css" href="style/tabs.css" />
        <link rel="stylesheet" type="text/css" href="style/tabstyles.css" />
        <link rel="stylesheet" ty=e="text/css" href="style/font-awesome.min.css">
    ...
    <body class='greybg' id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        include 'dist_head.php';
        include 'tab_head.php';
        ...
        echo("<section>");
        include 'dist_overview.php';
        echo("</section>");

        echo("<section>");
        include 'incumbent_page.php';
        echo("</section>");

        echo("<section>");
        include 'district_page.php';
        echo("</section>");

        echo("<section>");
        include 'cal_campaigns.php';
        echo("</section>");
