        ...
        <div class='row'>
            ...
            <div class='col-lg-12 '>
                <div class='panel'>
                    ...
                    <p>
                        Five editions are published during each election cycle, two in odd numbered off years and three in even numbered election years. Two editions will be published in 2019, and 2020 will see three editions editions--one prior to the March Primary, one prior to the General, and one following the General.
                    </p>
                </div>
            </div>
