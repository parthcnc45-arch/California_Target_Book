...
@section('title', 'December Visualization Summary | California Target Book')
...
<div class='container-fluid pt-lg' height='100%'>
    <h2>
        December 18th CD Visualization Summary
    </h2>
...
function populate_draft() {
	$conn = Util::get_ctb_conn();
	$sql = "SELECT * FROM ctb_redist_VIZ_1218_sum2";
...
function get_colors($section) {
  switch($section) {
    case "AD":
      //DARK BLUE - ASSEMBLY
      $head = "#00334d";
      $columns = Array("#ffffff", "#ffffff", "#e6f7ff", "#e6f7ff", "#e6f7ff", "#ffe6e6", "#ffe6e6", "#ffe6e6", "#ffffff", "#ffffff", "#e6f7ff", "#e6f7ff", "#e6f7ff", "#ffe6e6", "#ffe6e6", "#ffe6e6", "#ffffff", "#ffffff");
      break;
    case "SD":
