...
@section('title', 'Precinct Map Navigator | California Target Book')

@section('content')

    <form action="" enctype="text/plain" method="post" onsubmit="return valForm(this);">

        <div class='newseg container-fluid pt-lg' style='display: inline-block; margin-left: auto; margin-right: auto;'>
            ...
            <div class='inner' style='margin-left: auto; margin-right: auto;'>
                ...
                <div align='center'  style='margin-bottom: 20px;'>
                    ...
                    <select name="cd" class="distval form-control showonselect" id="cd" style="display: none;">
                        <option value="">Choose Congressional District</option>
                    ...
                    <select name="sd" id="sd" class="distval form-control showonselect" style="display: none;">
                        <option value=''>Choose State Senate District</option>
                    ...
                    <select name="co" id="co" class="distval form-control showonselect" style="display: none;">
                ...
                <div align='center'>
                    ...
                    <select name="election" id="election" class="distval form-control showonselect">
                ...
                <div align='center' style='margin-top: 20px;'>
                    ...
                    <select name="datavis" id="datavis" class="distval form-control showonselect">
    ...
    <script>
      ...
      function valForm(form) {
        ...
        if (error) {
          ...
          var URL = 'precinct_test_t?id=' + fourcode + datavisappend + electionappend;
