	...
	case "SD":
		switch($geo) {
			...
			case "SOCAL":
				...
				break;
			case "NORCAL":
				$dists = Array("SD01", "SD05", "SD06", "SD12", "SD14", "SD16", "SD98", "SD99");
				break;
			case "COAST":
	...
	case "AD":
		switch($geo) {
			case "LA":
				...
				break;
			case "SOCAL":
				$dists = Array("AD33", "AD40", "AD42", "AD47", "AD52", "AD55", "AD56", "AD60", "AD61", "AD65", "AD67", "AD68", "AD69", "AD71", "AD72", "AD73", "AD74", "AD75", "AD77", "AD78", "AD79", "AD80", "AD97" );
				break;
			case "NORCAL":
				$dists = Array("AD01", "AD03", "AD05", "AD06", "AD07", "AD08", "AD09", "AD12", "AD13", "AD21", "AD23", "AD26", "AD31", "AD32", "AD34");
				break;
			case "COAST":
				$dists = Array("AD02", "AD04", "AD10", "AD11", "AD14", "AD15", "AD16", "AD17", "AD18", "AD19", "AD20", "AD22", "AD24", "AD25", "AD27", "AD29", "AD30", "AD35", "AD37", "AD44", "AD96", "AD98");
				break;
...
foreach($sections as $section => $verbose) {
    ...
    $analysis_key = "VIZ3_" . $type . "_" . $geo . "_" . $distnum;
    $map_url = '/uploaded/viz21c/' . $verbose . '_Map.jpg';
    $res_url = '/uploaded/viz21c/' . $verbose . '_Res.jpg';
