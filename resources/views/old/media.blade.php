...
@section('title', 'Campaign Ads / Media | California Target Book')
...
<div class="container">
	...
	<div class='vid-list-container'>
    	<div class="vid-list">
					...
					if($results[1]) {
						...
						$vid_list .= "
								    <div class='vid-item' onClick=\"document.getElementById('vid_frame').src='https://www.youtube.com/embed/" . $results[1] . "'\">
										...
										<div class='desc'>
							    		<p class='caption'>" . $x['fourcode'] . " - " . $x['name'] . " (" . $position . " " . $x['candidate'] . ")</span><br>" . $x['type'] . " ad From " . $x['buyer'] . "</p>
							    		</div>
									</div>";
					}
				}
			...
			function get_vids($year) {
				//global $master_conn;
				//$conn = $master_conn;
				$conn = Util::get_ctb_conn();
				$sql = "SELECT * FROM ctb_ads_e18 WHERE year = $year && provider='youtube' ORDER BY id DESC";
