...
@section('content')
    ...
    if(!$county) {
	echo("<p align='center'>City of $sub</p>");
    }
    ...
    $alt_prop_table = generate_table($x);
    ...
    $prop_table = "<table width='1024px' class='bordered' cellspacing='0' border='0' align='center' id='districtWrapper' class='propTable' style='clear: both; margin-top: 10px;'>
				<tbody style='font-size: 12pt;' id='propTable'>
					<tr>
    ...
    if ($is_city) {
        echo("<div width='100%' align='center'><iframe style='margin-right: auto; margin-left: auto;' align='center' src='/book/get_city_demographics?id=$sub' width='1024px' frameborder='0' scrolling='no' onload='resizeIframe(this)'></iframe>");
    ...
    function generate_table($x)
    {
        ...
        $elections = Array("G08", "G10", "G12", "G14", "G16");
        ...
        $retval = "<table width='1024px' class='bordered' cellspacing='0' border='0' align='center' id='districtWrapper' class='propTable' style='clear: both; margin-top: 10px;'>
				<tbody style='font-size: 12pt;' id='propTable'>" . $html . "</tbody></table>";
	...
	if(!$county) {
	     $sql = "SELECT * FROM ctb2016_reg_hist WHERE SUBDIVISION = '$sub'";
	}
	...
	if(!$county) {
	     $sql = "SELECT * FROM ctb2016_vote_hist WHERE SUBDIVISION = '$sub'";
	}
