...
@section('title', '2018 Candidate Directory | California Target Book')

@section('content')

    <div class="book-page-head row m-n">
        <h2>Lookup 2018 Candidate/Incumbent</h2>
    </div>
...
@section('scripts')
    ...
    <script language="javascript">
      ...
      (function () {
        ...
        var currentType;
        var urlMap = {
          'ca_all': '/book/get_ca_roster?year=2018',
          'ca_inc': '/book/get_ca_roster?year=2018&type=inc',
          'us_all': '/book/get_us_roster?year=2018',
          'us_inc': '/book/get_us_roster?year=2018&type=inc',
        };
