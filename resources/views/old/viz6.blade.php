...
function get_cvap($type, $dists) {
	...
	foreach($dists as $fourcode) {
		...
		$cvap_table[$fourcode] = "
				...
				</table><h6 align='center' class='itcme'>The \"% '11\" column indicates the CVAP of the existing $old_fourcode at the time the lines were drawn in 2011, and the \"% '19\" column indicates the CVAP of the existing $old_fourcode as of the most recent American Community Survey</h6>";
