...
@section('title', 'Placeholder for 2020 Event')
...
@section('content')
    ...
    <ctb-event-signup inline-template class="container focused-form" :user="{{ json_encode($profile) }}"
        ...
        <div class="" id="event">
            ...
            <form class="form row" method="POST" action="/events/placeholder-2020-event" @submit="isLoading = true">
                {{ csrf_field() }}
                        ...
                        <div class="row m-n event-hero ">
                            ...
                            <div class="col-md-4 event-header">
                                <h5 class="upper text-red mb-lg">
                                    MON <br/> <span class="h4">DAY</span>
                                </h5>
                                <h3>Placeholder for 2020 Event</h3>
