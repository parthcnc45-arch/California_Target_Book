        ...
        */
        ...
        if ($primary_combined > 0) {
            ...
            foreach ($ie_cmte as $x) {
                ...
                $sup_span = '';
                $opp_span = '';
                $cmte_lnk = "<a href='http://198.74.49.22/cmlocal_fed18.php?id=" . $x['cmte_id'] . "' target='_blank'>" . $x['cmte_nm'] . "</a>";
		...
		<table class='bordered tablesorter tablesaw tablesaw-stack' data-tablesaw-mode='stack' style='font-weight: normal;'>
			<thead>
				<tr>
					<th>ELECTION</th>
					<th>CMTE</th>
