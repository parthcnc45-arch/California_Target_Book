...
@section('title', '2020 Candidate Directory | California Target Book')

@section('content')

    <div class="book-page-head row m-n">
        <h2>Lookup 2020 Candidate/Incumbent</h2>
    </div>
...
@section('scripts')
    ...
    <script language="javascript">
      ...
      (function () {
        ...
        var currentType;
        var urlMap = {
          'ca_all': '/book/get_ca_roster?year=2020',
          'ca_inc': '/book/get_ca_roster?year=2020&type=inc',
          'us_all': '/book/get_us_roster?year=2020',
          'us_inc': '/book/get_us_roster?year=2020&type=inc',
        };
