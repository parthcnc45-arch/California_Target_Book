...
switch($type) {
	...
	case "AD":
		switch($geo) {
			case "LA":
				$dists = Array("AD36", "AD38", "AD39", "AD41", "AD43", "AD45", "AD46", "AD48", "AD49", "AD50", "AD51", "AD57", "AD58", "AD59", "AD62", "AD63", "AD64", "AD66", "AD70", "AD96");
				break;
			case "SOCAL":
				$dists = Array("AD33", "AD40", "AD42", "AD47", "AD52", "AD55", "AD56", "AD60", "AD61", "AD65", "AD67", "AD68", "AD69", "AD71", "AD72", "AD73", "AD74", "AD75", "AD77", "AD78", "AD79", "AD80", "AD95" );
				break;
			case "NORCAL":
				$dists = Array("AD01", "AD03", "AD06", "AD07", "AD08", "AD09", "AD12", "AD13", "AD21", "AD23", "AD26", "AD31", "AD32", "AD34", "AD98");
				break;
			case "COAST":
				$dists = Array("AD02", "AD04", "AD10", "AD11", "AD14", "AD15", "AD16", "AD17", "AD18", "AD19", "AD20", "AD22", "AD24", "AD25", "AD27", "AD29", "AD30", "AD35", "AD37", "AD44", "AD97", "AD99");
				break;
...
foreach($sections as $section => $verbose) {
    ...
    $analysis_key = "VIZ5_" . $type . "_" . $geo . "_" . $distnum;
    $map_url = '/uploaded/viz21e/' . $verbose . '_Map.jpg';
    $res_url = '/uploaded/viz21e/' . $verbose . '_Res.jpg';
    $dif_url = '/uploaded/viz21e/' . $verbose . "_Diff.jpg";
	...
	if(isset($reg[$this_fourcode])) {
		$prev_span = "<h5 align='center' style=\"font-family: 'Lato';\" >Existing district has a " . $reg[$this_fourcode]['ADV'] . " registration advantage and voted " . $pres[$this_fourcode]['ADV'] . " in the 2020 election.</h5>";
		if($role === "admin") {
		$prev_span .= "<h6>DEM: " . number_format((($reg[$this_fourcode]['DEM'] / $reg[$this_fourcode]['TOT']) * 100), 2) . ", 
			       REP: " . number_format((($reg[$this_fourcode]['REP'] / $reg[$this_fourcode]['TOT']) * 100), 2) . "  |  
			       Biden: " . number_format((($pres[$this_fourcode]['PRSDEM01'] / $pres[$this_fourcode]['TOT']) * 100), 2) . ",
			       Trump: " . number_format((($pres[$this_fourcode]['PRSREP01'] / $pres[$this_fourcode]['TOT']) * 100), 2) . "</h6>";
		}
...
function get_cvap($type, $dists) {
	...
	$sql = "SELECT district, name, population, cvap_19, hisp, ind, black, asian, white, target, deviation FROM ctb_redist_cvap_1110";
	$result = $conn->query($sql);
	if($result->num_rows > 0) {
		while($row = $result->fetch_assoc()) {
			$map_nm = $row['name'];
				...
				<table class='table table-striped table-responsive'>
					<thead>
						<tr>
							...
							<th class='rightme'>% '11</th>
							<th class='rightme'>% '19</th>
						</tr>
					</thead>
					<tbody>
						$eth_body
