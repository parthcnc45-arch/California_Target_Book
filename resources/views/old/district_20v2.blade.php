...
// $currentHotsheets = get_today_hotsheets($fourcode);
// $recent_article=App\Book\Hotsheet::getRecentArticle();
...
<div class="container-fluid pt-lg">
	<div class="ctb-main-container ps-3 ps-xl-0" style="background-color:#eeeef1">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-12">
						<div class="ctb-districts-container">
							<ul class="nav nav-pills general-pill-tab mb-3  bg-white pt-2 ctb-inline-tab  ctb-border-radius" id="pills-tab">
								<!-- <li class="nav-item" role="presentation">
									<button class="nav-link active pb-3"id="pills-summary-tab" data-bs-toggle="pill" data-bs-target="#pills-summary" role="tab" aria-controls="pills-summary" aria-selected="true" >
										<span>Summary</span>
									</button>
								</li> -->
							...
							<div class="tab-content" id="pills-tabContent">
								...
								<div class="tab-pane fade" id="pills-cities"  >
									{{-- <div class="row mt-3">
										<div class="col-md-8">
											<div class="ctb-cities-top-container bg-white px-3 py-3 ctb-border-radius">
												<h2 class="mb-0">Top Cities</h2>
												<span>(2020 General Election Redistricting Data)</span>
												<div class="ctb-cities-top-table table-responsive">
											...
											<div class="ctb-cities-shasta-container bg-white px-3 py-3 mt-3 ctb-border-radius">
												<div class="d-flex justify-content-between align-items-center gap-2 flex-wrap">
													<div class="d-flex align-items-center gap-2">
														<h2>Shasta</h2>
														<span>112,739 - R +26.86% - 33.52%</span>
													</div>
													<div class="search-box">
														<label for="search" style="max-width: 340px;">
															<input type="text" class="py-1" name="search" id="search" placeholder="Search" style="max-width: 340px;">
														</label>
													</div>
												</div>
												<div class="table-responsive">
										...
										<div class="col-md-4">
											<div class="ctb-cities-info px-3 py-3 mb-2 bg-white ctb-border-radius">
												<h3>Shasta</h3>
												<span>112,739 - R +26.86% - 33.52%</span>
											</div>
											<div class="ctb-cities-info px-3 py-3 mb-2 bg-white ctb-border-radius">
								...
								<div class="tab-pane fade districts_tabs" id="pills-hot-sheets"  >
                                    <?php $candidates=getCandidatesName('calaccess_raw_e22_comm');?>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <form class="ctb-filter d-flex align-items-center gap-2" method="POST" action="{{ route('book.hotsheet.filterArticles') }}" id="filter-form">
                                            ...
                                            <div class="ctb-filters-btns d-flex justify-content-end align-items-center">
                                                <select id='distType' class="ctb-input">
                                                ...
                                                <select id='districtField' class="ctb-input d-none">
                                                ...
                                                {{-- <button type="button" id='filterByDate'>By Date</button> --}}
                                        ...
                                        @include('book.recentHotsheets' , [ 'recent_article' => App\Book\Hotsheet::getRecentArticle() ])
                                    </div>
								</div>
							</div>
						</div>
