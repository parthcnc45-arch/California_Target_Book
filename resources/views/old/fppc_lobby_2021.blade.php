...
@section('title', 'FPPC 2021 Lobbying Totals | California Target Book')
...
function get_lobby_table_firm() {
	$x = file_get_contents('uploaded/lobbyfirm2021q3.html');
	return $x;
}
...
function get_lobby_table_emp() {
	$x = file_get_contents('uploaded/lobbyemp2021q3.html');
	return $x;
