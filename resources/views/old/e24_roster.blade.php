...
@section('title', '2024 Candidate Directory | California Target Book')

@section('content')

    <div class="book-page-head row m-n">
        <h2>Lookup 2024 Candidate/Incumbent</h2>
    </div>
...
@section('scripts')
    ...
    <script language="javascript">
      ...
      (function () {
        ...
        var currentType;
        var urlMap = {
          'ca_all': '/book/get_ca_roster?year=2024',
          'ca_inc': '/book/get_ca_roster?year=2024&type=inc',
          'us_all': '/book/get_us_roster?year=2024',
          'us_inc': '/book/get_us_roster?year=2024&type=inc',
        };
