...
echo("<br>JUL '16:<br>Dem Advantage: $demadv<br>Rep Advantage: $gopadv<br>");
...
echo("<br>JUL Dem Advantage: $demadv<br>Rep Advantage: $gopadv<br>");
$gopadv = 0;
$demadv = 0;
$olddemadv = 0;
$oldgopadv = 0;
...
function getreg($fourcode) {
	...
	$sql = "SELECT * FROM  sos_jul16 WHERE DIST = '$fourcode'";
