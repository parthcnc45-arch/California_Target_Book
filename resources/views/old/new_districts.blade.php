	...
	<!-- <div class="ctb-main-container"> -->
		<div class="row">
			...
			<div class="ctb-rabban headingDiv">
				<h5>Districts Stats</h5>
			</div>
			<div class="d-flex justify-content-between flex-sm-row flex-column">
				<div class="ctb-stats-box">
				<h2>Assembly</h2>
				<div class="d-flex justify-content-between">
					<div class="ctb-stats-counter">
					<h3>80</h3>
					...
					<div class="ctb-stats-counter">
					<h3>74</h3>
					<span>Un Changed</span>
					</div>
					<div class="ctb-stats-counter">
					<h3>4</h3>
					<span>Substractions</span>
					</div>
				</div>
				</div>
				<div class="ctb-stats-box">
					...
					<div class="ctb-directory-column">
						<ul class="nav nav-pills mb-3 general-pill-tab" id="pills-tab" >
							<li class="nav-item active">
								<a class="nav-link" data-toggle="pill" href="#pills-assembly">80<span>Assembly</span></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="pill" href="#pills-stateSenate">40<span>State Senate</span></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="pill" href="#pills-congress">52<span>Congress</span></a>
							</li>
						</ul>
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade active in" id="pills-assembly">
								@include('old.new_districts_tables',['section' => 'assembly'])
							</div>
							<div class="tab-pane fade" id="pills-stateSenate">
								@include('old.new_districts_tables',['section' => 'stateSenate'])
							</div>
							<div class="tab-pane fade" id="pills-congress">
								@include('old.new_districts_tables',['section' => 'congress'])
							</div>
						</div>
					</div>
					</div>
					<div class="col-md-4">
					<div class="ctb-directory-column h-100">
						<div
						class="d-flex justify-content-around ctb-map-box text-center"
						>
                            <div>
                                <h4 id='new_heading'>AD 01</h4>
                                <span>NEW #</span>
                            </div>
                            <div>
                                <h4 id='old_heading'>AD 01</h4>
                                <span>OLD #</span>
                            </div>
                            <div class="pb-4">
                                <h4 id='incumbent_heading'>Megan Dahle</h4>
                                <span>Incumbent</span>
                            </div>
						</div>
                        <iframe id='map-iframe' src='/ctb-legacy/draw_viz.php?city=VIZ8_AD&cd=1"' width='750' height='430' align='center' scrolling='no'></iframe>
					</div>
					</div>
				</div>
			</div>
